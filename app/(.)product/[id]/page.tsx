    ...
    >
      ...
      <div className="fixed inset-0 flex items-center justify-center p-4">
        ...
        <Dialog.Panel className="mx-auto max-w-3xl rounded bg-white p-10">
          {loading ? (
            <div className="h-8 w-8 rounded-full border-2 border-dotted border-blue-600 animate-spin duration-75" />
          ) : (
              ...
              <div className="flex-1 flex flex-col">
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <button
                    ...
                    className="button w-full bg-transparent text-blue-600 hover:bg-blue-600 hover:text-white hover:border-transparent"
                  >
                    View Full Details
                  </button>
                </div>
